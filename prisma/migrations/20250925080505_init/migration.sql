...
CREATE TABLE "LoanType" (
    ...
    "insuranceFeePercentage" DOUBLE PRECISION DEFAULT 0,
    "collateralLogic" TEXT NOT NULL DEFAULT 'GUARANTOR',
    "collateralThresholdAmount" DOUBLE PRECISION,
    "minSavingMonths" INTEGER DEFAULT 0,
    "minSavingBalance" DOUBLE PRECISION DEFAULT 0,
    "purposes" TEXT[],
...
-- AddForeignKey
ALTER TABLE "LoanRepayment" ADD CONSTRAINT "LoanRepayment_memberId_fkey" FOREIGN KEY ("memberId") REFERENCES "Member"("id") ON DELETE NO ACTION ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "HeroSlide" ADD CONSTRAINT "HeroSlide_contentId_fkey" FOREIGN KEY ("contentId") REFERENCES "WebsiteContent"("id") ON DELETE CASCADE ON UPDATE CASCADE;
