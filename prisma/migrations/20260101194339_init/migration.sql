...
-- AddForeignKey
ALTER TABLE "MemberSavingAccount" ADD CONSTRAINT "MemberSavingAccount_savingAccountTypeId_fkey" FOREIGN KEY ("savingAccountTypeId") REFERENCES "SavingAccountType"("id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "MemberShareCommitment" ADD CONSTRAINT "MemberShareCommitment_shareTypeId_fkey" FOREIGN KEY ("shareTypeId") REFERENCES "ShareType"("id") ON DELETE SET NULL ON UPDATE NO ACTION;
