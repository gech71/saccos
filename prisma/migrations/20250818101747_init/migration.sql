...
-- CreateIndex
CREATE INDEX "MemberSavingAccount_memberId_idx" ON "MemberSavingAccount"("memberId");

-- CreateIndex
CREATE INDEX "MemberSavingAccount_savingAccountTypeId_idx" ON "MemberSavingAccount"("savingAccountTypeId");

-- CreateIndex
CREATE INDEX "Saving_memberId_idx" ON "Saving"("memberId");

-- CreateIndex
CREATE INDEX "Saving_memberSavingAccountId_idx" ON "Saving"("memberSavingAccountId");

-- CreateIndex
CREATE UNIQUE INDEX "ShareType_name_key" ON "ShareType"("name");

-- CreateIndex
CREATE INDEX "MemberShareCommitment_memberId_idx" ON "MemberShareCommitment"("memberId");

-- CreateIndex
CREATE UNIQUE INDEX "MemberShareCommitment_memberId_shareTypeId_key" ON "MemberShareCommitment"("memberId", "shareTypeId");

-- CreateIndex
CREATE INDEX "SharePayment_commitmentId_idx" ON "SharePayment"("commitmentId");

-- CreateIndex
CREATE INDEX "Dividend_memberId_idx" ON "Dividend"("memberId");
...
-- CreateIndex
CREATE INDEX "Collateral_loanId_idx" ON "Collateral"("loanId");
...
-- CreateIndex
CREATE INDEX "AppliedServiceCharge_memberId_idx" ON "AppliedServiceCharge"("memberId");
...
-- AddForeignKey
ALTER TABLE "LoanRepayment" ADD CONSTRAINT "LoanRepayment_memberId_fkey" FOREIGN KEY ("memberId") REFERENCES "Member"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
