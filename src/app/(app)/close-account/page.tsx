                ...
                <PopoverContent className="w-[--radix-popover-trigger-width] p-0">
                    ...
                    <CommandList>
                        ...
                        {activeMembers.map((member) => (
                            ...
                            />
                            {member.fullName} (Acct: {member.savingsAccountNumber || 'N/A'}, Bal: Birr {member.savingsBalance.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })})
                            </CommandItem>
                        ))}
                        </CommandGroup>
                    </CommandList>
          ...
          <Card className="shadow-lg animate-in fade-in duration-300">
            ...
            <CardContent className="space-y-6">
                <Alert>
                    ...
                    <AlertDescription>
                        <div className="flex justify-between py-1"><span>Current Savings Balance:</span> <span className="font-medium">Birr {calculationResult.currentBalance.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span></div>
                        <div className="flex justify-between py-1"><span>Accrued Interest (Calculated):</span> <span className="font-medium text-green-600">+ Birr {calculationResult.accruedInterest.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span></div>
                        <Separator className="my-1"/>
                        <div className="flex justify-between py-1 text-lg"><strong>Total Payout Amount:</strong> <strong className="text-primary">Birr {calculationResult.totalPayout.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</strong></div>
                    </AlertDescription>
                </Alert>
