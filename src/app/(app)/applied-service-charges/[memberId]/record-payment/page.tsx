  ...
  return (
    <div className="space-y-6">
        <div className="flex items-center justify-between">
            <PageTitle title={`Record Payment for ${decodeURIComponent(memberName)}`} subtitle={`Total Pending Service Charges: $${totalPending.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`} />
